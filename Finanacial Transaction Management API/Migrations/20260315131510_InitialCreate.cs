    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerAddresses_CustomerId_IsDeleted",
                table: "CustomerAddresses",
                columns: new[] { "CustomerId", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_CustomerAddresses_CustomerId_IsMain",
                table: "CustomerAddresses",
                columns: new[] { "CustomerId", "IsMain" },
                unique: true,
                filter: "IsMain = 1 AND IsDeleted = 0");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerEmails_CustomerId_IsDeleted",
                table: "CustomerEmails",
                columns: new[] { "CustomerId", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_CustomerEmails_CustomerId_IsMain",
                table: "CustomerEmails",
                columns: new[] { "CustomerId", "IsMain" },
                unique: true,
                filter: "IsMain = 1 AND IsDeleted = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerPhones_CustomerId_IsDeleted",
                table: "CustomerPhones",
                columns: new[] { "CustomerId", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_CustomerPhones_CustomerId_IsMain",
                table: "CustomerPhones",
                columns: new[] { "CustomerId", "IsMain" },
                unique: true,
                filter: "IsMain = 1 AND IsDeleted = 0");
